...
!(function (n, e, t) {
            ...
            if (((I = null), delete B.unpause, Q)) n();
                ...
                for (; C.length; ) {
                    ...
                    try {
                        ...
                        a(r)
                            ? (z = z.concat(r))
                            : (z.push(r), r.stack && z.push(r.stack)),
            ...
            return M || Q || 0 === arguments.length
                ...
                : (m.call(arguments).forEach(function (n) {
                      ...
                      a(n) &&
                          ...
                          d(function (e) {
                              a(n) || (n = n.apply(y, m.call(arguments, 1))),
                                  n.pipe(e);
                          });
                  }),
                  B);
        ...
        function k() {
            function n(n) {
                return function () {
                    n.apply(
                        y,
                        s.isMessageWrapper(arguments[0])
                            ? arguments[0]
                            : arguments
                    );
                };
    ...
    return (
        ...
        (s.extend = function (n, e) {
            return (
                ~["then", "or", "gate", "pipe", "seq", "val", "abort"].indexOf(
                    n
                ) || (p[n] = e),
                s
            );
            ...
            return function () {
                ...
                return (
                    ...
                    function (n) {
                        n
                            ? r.or_cb(n)
                            : r.then_cb.apply(e, t.call(arguments, 1));
                    }
                );
            };
        }),
        ...
        (function () {
            ...
            n.iterable = function () {
                ...
                function o() {
                    if (v || b || 0 === d.length)
                        return (
                            d.length > 0 && c("Sequence cannot be iterated"),
                            { done: !0 }
                        );
                    try {
                ...
                return (
                    ...
                    t &&
                        ((d = t.val_queue.slice(0)), (_ = t.or_queue.slice(0))),
